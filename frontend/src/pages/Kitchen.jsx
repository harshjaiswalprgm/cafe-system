      ...
      <div className="max-w-7xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        {orders.map((order, index) => {
          ...
          if (order.status === "Pending") {
            statusClasses = "bg-yellow-300 text-black border border-yellow-500";
          } else if (order.status === "Preparing") {
            statusClasses =
              "bg-blue-400 text-black border border-blue-600 status-preparing";
          } else if (order.status === "Ready") {
            statusClasses = "bg-green-400 text-black border border-green-600";
          } else if (order.status === "Served") {
            statusClasses = "bg-slate-300 text-black border border-slate-500";
            ...
            >
              ...
              <div className="flex justify-between items-start gap-2">
                <div>
                  ...
                  <p className="text-[11px] opacity-60">Bill #{order.billNo}</p>
                </div>
              ...
              <div className="space-y-1 text-xs">
                ...
                <div className="flex justify-between font-bold">
                  <span>Payment</span>
                  <span className={paid ? "text-green-600" : "text-yellow-600"}>
                    {order.paymentStatus}
                  </span>
                </div>
              </div>
